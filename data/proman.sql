...
insert into statuses values (4, 'new');
insert into statuses values (5, 'in progress');
insert into statuses values (6, 'testing');
insert into statuses values (7, 'done');
...
insert into board_statuses (board_id, status_id) values (2,4);
